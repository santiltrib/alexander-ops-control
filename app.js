const DATA_URL = './data/current_backlog_2026-06-26.json';
const ENCRYPTED_DATA_URL = './data/current_backlog_2026-06-26.enc.json';
const STORAGE_KEY = 'alexander-ops-cloud-skeleton-v0-6-daily-control';
